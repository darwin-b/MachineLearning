...
testDataFiles  = ["test_c1500_d1000","test_c1800_d1000"]
validDataFiles = ["valid_c1500_d1000","valid_c1800_d1000"]
trainDataFiles = ["train_c1500_d1000","train_c1800_d1000"]
...
for file in range(0,files):
    ...
    dataList.append(dataTrain)
    targetList.append(target)


num_cores = multiprocessing.cpu_count()
print("Cores available : ",num_cores)
modelList = Parallel(n_jobs=num_cores-2)(delayed(dTree)(dataList[x],targetList[x]) for x in range(0,len(dataList)))

# fileModel[file]=dTree(dataTrain,target)

for file in range(0,files):
    fileModel[file] = modelList[file]
    y_pred = {}
